...
<form action="{{ route('backend.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="pb-4">
                        ...
                        <div class="upload">
                            <div class="mb-3">
                                <img src="{{ !empty($user->avatar) ? asset('storage/images/' . $user->avatar) : Vite::asset('resources/images/no-avt.png') }}" alt="{{ !empty($user->avatar) ? 'avatar' : 'no-avatar' }}" width="100" height="100" id="avtPreview">
                            </div>
                            <div class="round">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group date" id="birthday">
                                <input type="text" class="form-control" name="birthday" value="{{ old('birthday', \Carbon\Carbon::parse($user->birthday)->format('Y-m-d')) }}" placeholder="dd/mm/yyyy">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" name="description">{{ old('description', $user->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        ...
        <button class="btn btn-sm btn-success" type="submit">{{ __('title.save') }}</button>
    </div>
</form>
@endsection
@section('css')
